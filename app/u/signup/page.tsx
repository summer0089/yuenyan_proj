...
import SignupForm from "@/components/form_auth/signup";
import { CarouselItem } from "@/utils/types/carousel_item";

// Carousel images data for auth pages
const CAROUSEL_IMAGES: CarouselItem[] = [
  {
    ...
    location: "",
    description:
      "ค้นหาห้องประชุม เลือกวันและเวลาที่ต้องการ พร้อมส่งคำขอจองได้อย่างรวดเร็ว ลดขั้นตอนการติดต่อและประสานงานแบบเดิม",
  },
  {
    ...
    location: "",
    description:
      "ตรวจสอบสถานะห้องประชุมและช่วงเวลาที่ถูกจองได้ทันที ช่วยให้เลือกห้องและเวลาที่เหมาะสมได้ง่าย ลดปัญหาการจองซ้ำหรือการใช้ห้องไม่ตรงเวลา",
  },
  {
  ...
  return (
    <div className="min-h-screen w-full flex bg-[#f8f9fa] font-sans antialiased text-slate-800">
      ...
      <div className="w-full flex min-h-screen">
        ...
        <div className="w-full lg:w-7/12 flex flex-col justify-between p-6 sm:p-10 md:p-14 lg:p-16 bg-white overflow-y-auto">
